...
public class level2_r1 extends AppCompatActivity {
    TextView Tv1,Tv2;
    ...
    Integer[] cardsArray = {101,102,103,104,105,106,107,108,201};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2_r1);
    ...
    private  void  checkEnd(){
        ...
        if(imageView1_1.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(level2_r1.this);
            alertDialogBuilder
